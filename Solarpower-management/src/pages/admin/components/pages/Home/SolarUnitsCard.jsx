...
import { useDeleteSolarUnitMutation } from "@/lib/redux/query";
import { useUpdateRegisteredUserMutation } from "../../../../../lib/redux/query";
...
const SolarUnitCard = ({
  ...
  const [deleteSolarUnit, { isLoading }] = useDeleteSolarUnitMutation();
  const [isDeleteSolarUnit, setIsDeleteSolarUnit] = useState(false);
  const [updateUser, { isLoading: createUpdate }] =
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      console.log("Solar unit deleted");
    } catch (error) {
    ...
    <>
            ...
            <div className="p-6 space-y-4 overflow-y-auto max-h-[calc(90vh-140px)]">
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-gray-50 p-4 rounded-xl border border-gray-200">
                  ...
                  <p className="text-xl font-bold text-primary-dark ml-12">
                    {SerialNumber}
                  </p>
                </div>
                ...
                <div className="bg-gray-50 p-4 rounded-xl border border-gray-200">
                  ...
                  <p className="text-sm font-bold text-gray-800 ml-12">
                    {UserID}
                  </p>
                </div>
                ...
                <div className="bg-gray-50 p-4 rounded-xl border border-gray-200">
                  ...
                  <p className="text-xl font-bold text-gray-800 ml-12">
                    {capacity} kW
                  </p>
                </div>
              ...
              <div className="bg-primary/5 p-4 rounded-xl border border-primary/20 mt-6">
                ...
                <p className="text-sm text-gray-600">
                  This solar unit is currently {status?.toLowerCase()} and has
                  been operational since {InstalledDate}. The unit has a
                  capacity of {capacity} kW.
                </p>
              </div>
            </div>
      ...
      {isEditing && (
        ...
        >
          ...
          {isDeleteSolarUnit && (
            <AlertDialog open={open} onOpenChange={isDeleteSolarUnit}>
              <AlertDialogContent>
                <AlertDialogHeader>
                  <AlertDialogTitle>
                    Do you really want to delete this Solar Unit?
                  </AlertDialogTitle>
                  <AlertDialogDescription>
                    Deleting this will permanently remove all data related to
                    this solar unit. This action cannot be undone.
                  </AlertDialogDescription>
                </AlertDialogHeader>

                <AlertDialogFooter>
                  <AlertDialogCancel
                    onClick={() => setIsDeleteSolarUnit(false)}
                  >
                    Cancel
                  </AlertDialogCancel>
